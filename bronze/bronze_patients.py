...
# MAGIC %md
# MAGIC ## Bronze Layer - Patients
# MAGIC
# MAGIC **Objective**
# MAGIC
# MAGIC Ingest incremental patient data using Auto Loader,
...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS healthcare.bronze.patients
# MAGIC USING DELTA
# MAGIC LOCATION 'abfss://bronze@nanadls.dfs.core.windows.net/patients'
